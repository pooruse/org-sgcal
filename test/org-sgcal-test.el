...
(ert-deftest test-org-sgcal/token-and-fetch ()
  ...
  (should (equal (with-temp-buffer
		 ...
		 (concat "* My self for test\n"
			 ...
			 "*** hee\n"
			 "   DEADLINE: "
                         (convert-time-to-org-string '(nil nil nil 2 4 2018 nil))
                         " SCHEDULED: "
                         (convert-time-to-org-string '(nil nil nil 1 4 2018 nil))
                         "\n"
			 "   :PROPERTIES:\n"
			 "   :ID:       test\n"
			 "   :UPDATED:  2018-01-01T01:02:03Z\n"
			 ...
			 "*** hee\n"
			 "   DEADLINE: "
                         (convert-time-to-org-string '(0 0 20 2 4 2018 nil))
                         " SCHEDULED: "
                         (convert-time-to-org-string '(0 0 8 1 4 2018 nil))
                         "\n"
			 "   :PROPERTIES:\n"
			 "   :ID:       test2\n"
			 "   :UPDATED:  2018-01-01T01:02:03Z\n"
...
(ert-deftest test-org-sgcal/search-up ()
    ...
    (should (equal (with-temp-buffer
		     ...
		     (insert "* test headline1\n"
			     ...
			     "*** TODO test headline3\n"
			     "    DEADLINE: "
                             (convert-time-to-org-string '(0 34 13 10 4 2018 nil))
                             " SCHEDULED: "
                             (convert-time-to-org-string '(0 34 12 10 4 2018 nil))
                             "\n"
			     "    :PROPERTIES:\n"
			     "    :ID:       test-id\n"
  ...
  (should
   (equal (with-temp-buffer
	  ...
	  (concat "* test headline1\n"
		  ...
		  "*** OK I am good\n"
		  "    DEADLINE: "
                  (convert-time-to-org-string '(nil nil nil 5 4 2018 nil))
                  " SCHEDULED: "
                  (convert-time-to-org-string '(nil nil nil 3 4 2018 nil))
                  "\n"
		  "    :PROPERTIES:\n"
		  "    :ID:       Id is here\n"
		  "    :UPDATED:  2018-04-04T00:05:30Z\n"
...
(ert-deftest test-org-sgcal/apply-at-tags ()
  (should (equal (with-temp-buffer
                   ...
                   (insert "* heading2 for test\n"
                           ...
                           "*** event_1                                                          :UPDATE:\n"
                           "    SCHEDULED: "
                           (convert-time-to-org-string '(nil nil nil 18 4 2018 nil))
                           "\n"
                           "*** event_2                                                          :DELETE:\n"
                           "    DEADLINE: "
                           (convert-time-to-org-string '(nil nil nil 19 4 2018 nil))
                           " SCHEDULED: "
                           (convert-time-to-org-string '(nil nil nil 18 4 2018 nil))
                           "\n"
                           "    :PROPERTIES:\n"
